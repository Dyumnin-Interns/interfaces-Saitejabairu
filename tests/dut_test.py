...
async def dut_test(dut):
    ...
    dut.RST_N.value = 1
    await Timer(50, units="ns")  # Let DUT stabilize
    ...
    for _ in range(20):
        ...
        await Timer(10, units="ns")  # Wait before polling again
    ...
    while input_queue:
        ...
        if y_ready:
            ...
            if timeout_cycles > max_timeout:
                raise cocotb.result.TestFailure(f"Timeout waiting for Y output. Remaining: {list(input_queue)}")
